...
export function ProductsPage({ navigationTarget }: ProductsPageProps) {
  ...
  if (mode === 'create' || mode === 'edit') {
    return (
      ...
      >
        <form className="yumi-form-panel" id="product-workspace-form" onSubmit={submit}>
    ...
    >
      {selected ? (
        <>
          ...
          {detailTab === 'inventory' ? <ProductInventoryPanel product={selected} /> : null}
        </>
      ) : (
