...
function OrderDetail(props: {
  ...
  shipmentQuantities: Map<string, number>; submitting: string | null; updateContentLine: (index: number, key: keyof OrderLineDraft, value: string) => void; onAddContentLine: () => void; onRemoveContentLine: (index: number) => void; onContentChange: (event: FormEvent<HTMLFormElement>) => void; onRecordFund: (event: FormEvent<HTMLFormElement>) => void; onCorrection: (event: FormEvent<HTMLFormElement>) => void; onShipment: (event: FormEvent<HTMLFormElement>) => void
}) {
