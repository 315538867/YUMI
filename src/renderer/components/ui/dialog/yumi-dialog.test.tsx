...
describe('YUMI 浮层', () => {
  it('危险确认弹窗在明确确认前不执行操作', () => {
    ...
    render(<YumiConfirmDialog confirmLabel="删除订单" onConfirm={onConfirm} onOpenChange={vi.fn()} open title="确认删除？" />)
  ...
  it('有未保存内容的抽屉关闭时先请求放弃确认', () => {
    ...
    render(<YumiSheet dirty onOpenChange={onOpenChange} open title="编辑客户">内容</YumiSheet>)
